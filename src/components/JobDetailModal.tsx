...
import { generateProposal, generateProposalWithClaude, answerClientQuestion } from '../services/proposals';
    ...
    >
      <div className="bg-white rounded-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-lg">
        ...
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
          {/* AI Detection Test Warning */}
          {currentJob.proposal?.aiDetectionWarning?.detected && (
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 flex-1">
                  <h3 className="text-sm font-semibold text-yellow-800">
                    {currentJob.proposal.aiDetectionWarning.message}
                  </h3>
                  <div className="mt-2 text-sm text-yellow-700">
                    <p className="mb-2">This job contains instructions to filter AI-generated proposals. Your proposal has been generated to avoid these traps, but you should:</p>
                    <ul className="list-disc ml-5 space-y-1">
                      {currentJob.proposal.aiDetectionWarning.suggestions.map((suggestion, i) => (
